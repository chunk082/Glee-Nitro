...
import { useConfigurationEvent, useGroupForumManager, useLocalizationEvent, useMainEvent, useRoomEngineEvent } from './hooks';
...
export const App: FC<{}> = props =>
{
    ...
    useGroupForumManager(
        (groupId, threads) => {
          console.log('[App.tsx] Received threads for group', groupId, threads);
        },
        (info) => {
          console.log('[App.tsx] Received group info', info);
        }
      );
